...
const PAGE_TITLES: Array<[prefix: string | RegExp, title: string]> = [
  ...
  ['/attendance/holiday-work', 'دوام أيام العطلات'],
  ...
  ['/reports/payroll-register', 'تقرير الرواتب'],
  ['/reports/payroll-cost', 'ملخص تكلفة الرواتب'],
  ['/reports/deductions', 'تقرير الخصومات'],
  ['/reports/loans', 'تقرير السلف'],
  ...
  ['/settings/policies', 'سياسات النظام'],
