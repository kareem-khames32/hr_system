...
function TemplatesWorkspace() {
  ...
  return <div className="space-y-6 pb-10">
    <div className="flex flex-wrap items-start justify-between gap-4">
      <div className="flex gap-3"><div className="w-12 h-12 rounded-2xl bg-primary-100 text-primary-700 flex items-center justify-center"><FileSignature size={25} /></div><div><Link href="/settings" className="text-xs text-gray-500 hover:underline">الإعدادات</Link><h1 className="text-2xl font-bold text-gray-800">قوالب المستندات</h1><p className="text-sm text-gray-500 mt-1">جهّز العقود والإقرارات والشهادات ومستندات الموارد البشرية.</p></div></div>
