    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center p-4" dir="rtl">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          {/* SSO Login */}
          <button className="w-full border border-gray-200 hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-xl transition-colors flex items-center justify-center gap-2">
        ...
        <p className="text-center text-primary-100 mt-8 text-sm">
          © 2024 نظام HR - جميع الحقوق محفوظة
        </p>
      </div>
    </div>
  )
