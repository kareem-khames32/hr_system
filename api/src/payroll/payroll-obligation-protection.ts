...
// بدل ضغط العمل (قرار المالك 26 سبتمبر) مش مدخل هنا خالص: earnedFixedGross = المكونات الست المستحقة بس، فالرصيد والأرضية
// والسقف ومساحة الخصم وموضع السلف كلها من غيره، والبدل بيتضاف للصافي بعد الحماية والأقساط (payroll-work-pressure.ts) —
// يعني ولا خصم ولا دين ولا قسط بياخد منه حتى لو الخصومات أكبر من الراتب.
