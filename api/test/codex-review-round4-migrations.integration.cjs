...
test('CR4 migrations 068 and 069 are additive, idempotent and match all entity metadata',async t=>{
  const f=await require('./codex-review-round4-fixture.cjs')('r4migrations')
  try{
